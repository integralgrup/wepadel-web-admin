                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body grids-4">
                                        ...
                                        <div class="mb-3">
                                            <label for="button_text_{{ $language->lang_code }}" class="form-label">Buton Text ({{ strtoupper($language->lang_code) }})</label>
                                            <input type="text" class="form-control" id="button_text_{{ $language->lang_code }}" name="button_text_{{ $language->lang_code }}" {{ $required }}>
                                        </div>
                                        <div class="mb-3">
                                            <label for="button_url_{{ $language->lang_code }}" class="form-label">Buton URL({{ strtoupper($language->lang_code) }})</label>
                                            <input type="text" class="form-control" id="button_url_{{ $language->lang_code }}" name="button_url_{{ $language->lang_code }}" {{ $required }}>
                                        </div>
                                        <div class="mb-3">
