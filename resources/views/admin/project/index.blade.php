...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Proje Listesi</h3></div>
              <div class="col-sm-6">
                            ...
                            <tbody>
                                @foreach($projects as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.project.gallery.index', $item->project_id) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-images"></i> Galeri
                                            </a>
                                            <a href="{{ route('admin.project.edit', $item->project_id) }}" class="btn btn-success btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <form action="{{ route('admin.project.destroy', $item->project_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
