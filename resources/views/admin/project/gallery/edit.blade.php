...
@section('title', 'Proje Galeri Görseli Güncelleme')
<?php 
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Proje Galeri Görseli Güncelleme</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <?php 
                        foreach($gallery as $photo){
                            $image[$photo->lang] = $photo->image;
                            $title[$photo->lang] = $photo->title;
                            $alt[$photo->lang] = $photo->alt;
                            $sort[$photo->lang] = $photo->sort;
                        }
                    ?>
                    <div class="card-body">
                        <form action="{{ route('admin.project.gallery.store', $project->project_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if($image[$language->lang_code])
                                                <img src="{{ $language->domain .'/'.  getFolder(['uploads_folder','project_images_folder'], $language->lang_code) . '/' . $image[$language->lang_code] }}" alt="{{ $alt[$language->lang_code] }}" style="width: 200px; height: auto; margin-top: 10px;">
