...
@section('title', 'Hakkımızda(Sertifikalar) Ekleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Hakkımızda(Sertifikalar) Ekleme</h3></div>
              <div class="col-sm-6">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <!-- pdf file -->
                                        <div class="mb-3">
                                            <label for="pdf_{{ $language->lang_code }}" class="form-label">PDF Dosyası ({{ $language->lang_code }})</label>
                                            <input type="file" class="form-control" id="pdf_{{ $language->lang_code }}" name="pdf_{{ $language->lang_code }}" accept="application/pdf" {{ $required }}>
                                        </div>
                                        <!-- sort -->
                                        <div class="mb-3">
