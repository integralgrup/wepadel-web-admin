...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Hakkımızda(Neler Yaparız) Listesi</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Hakkımızda(Neler Yaparız) Listesi</h5>
                            <a href="{{ route('admin.about.what_we_do.create') }}" class="btn btn-primary">
