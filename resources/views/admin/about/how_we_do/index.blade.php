                            ...
                            <tbody>
                                @foreach($how_we_do as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.about.how_we_do.edit', $item->content_id) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <form action="{{ route('admin.about.how_we_do.destroy', $item->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
