...
@section('title', 'Hakkımızda(Slider) Güncelleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Hakkımızda(Slider) Güncelleme</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <?php 
                        foreach($sliders as $slider){
                            ...
                            $image[$slider->lang] = $slider->image;
                            $alt[$slider->lang] = $slider->alt;
                            $sort[$slider->lang] = $slider->sort;
                        }

                    ?>
                    <div class="card-body">
                        <form action="{{ route('admin.about.slider.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('admin.about.slider') }}" class="btn btn-secondary">Geri Dön</a>
                            </div>
                        </form>
                    </div>
                </div>
