...
@section('title', 'Kulüp Özellik Güncelleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Kulüp Özellik Güncelleme</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a></li>
                  <li class="breadcrumb item active" aria-current="page">Kulüp Özellik Yönetimi</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
        ...
        <div class="app-content">
                ...
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <form action="{{ route('admin.club.features.store', $club_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="form-group">
                                            <label for="icon_{{ $language->lang_code }}">İkon ({{ strtoupper($language->lang_code) }})</label>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('admin.club.features.index', $club_id) }}" class="btn btn-secondary">Geri Dön</a>
                            </div>
                        </form>
                    </div>
                </div>
