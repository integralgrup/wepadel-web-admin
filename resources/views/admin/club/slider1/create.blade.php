...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Slider 1 Ekleme</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Slider 1 Yönetimi</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
        ...
        <div class="app-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.club.slider1.store', $club->club_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description_{{ $language->lang_code }}" name="description_{{ $language->lang_code }}" rows="4" {{ $required }}></textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label for="icon_{{ $language->lang_code }}" class="form-label">İkon ({{ strtoupper($language->lang_code) }})</label>
                                            <input type="file" class="form-control" id="icon_{{ $language->lang_code }}" name="icon_{{ $language->lang_code }}" {{ $required }}>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <!-- video --> 
                                        <div class="mb-3">
                                            <label for="video_{{ $language->lang_code }}" class="form-label">Video ({{ strtoupper($language->lang_code) }})</label>
                                            <input type="file" class="form-control" id="video_{{ $language->lang_code }}" name="video_{{ $language->lang_code }}" {{ $required }}>
                                        </div>
                                        <!-- video -->
                                        <div class="mb-3">
