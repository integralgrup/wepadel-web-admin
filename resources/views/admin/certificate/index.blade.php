...
@section('title', 'Sertifika Listesi')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Sertifika Listesi</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Sertifika Listesi</h5>
                                ...
                                @foreach($certificates as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.certificate.edit', $item->certificate_id) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <form action="{{ route('admin.certificate.destroy', $item->certificate_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
