...
@section('title', 'Sertifika Ekleme')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="grids-4">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" class="form-control" id="pdf_file_{{ $language->lang_code }}" name="pdf_file_{{ $language->lang_code }}" accept="application/pdf" {{ $required }}>
                                            </div>
                                        </div>
