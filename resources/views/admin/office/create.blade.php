...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Ofis Ekleme</h3></div>
              <div class="col-sm-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="grids-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="address_{{ $language->lang_code }}" name="address_{{ $language->lang_code }}" rows="3" {{ $required }}></textarea>  
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="grids-4">
                                            ...
                                            <div class="mb-3">
                                                <label for="longitude_{{ $language->lang_code }}" class="form-label">Boylam ({{ $language->lang_code }})</label>
                                                <input type="text" class="form-control" id="longitude_{{ $language->lang_code }}" name="longitude_{{ $language->lang_code }}" {{ $required }}>
                                            </div>
                                            <div class="mb-3">
