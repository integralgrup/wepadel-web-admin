                ...
                <div class="card">
                    ...
                    <?php 
                        foreach($offices as $office){
                            ...
                            $longitude[$office->lang] = $office->longitude;
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body">
                                        <div class="grids-3">
                                            ...
                                            <div class="form-group">
                                                <label for="address_{{ $language->lang_code }}">Adres ({{ strtoupper($language->lang_code) }})</label>
                                                <textarea class="form-control" id="address_{{ $language->lang_code }}" name="address_{{ $language->lang_code }}" rows="3" >{{ $address[$language->lang_code] }}</textarea>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="grids-4">
                                            ...
                                            <div class="form-group">
                                                <label for="longitude_{{ $language->lang_code }}">Boylam ({{ strtoupper($language->lang_code) }})</label>
                                                <input type="text" class="form-control" id="longitude_{{ $language->lang_code }}" name="longitude_{{ $language->lang_code }}" value="{{ $longitude[$language->lang_code] }}" >
                                            </div>
                                            <div class="form-group">
