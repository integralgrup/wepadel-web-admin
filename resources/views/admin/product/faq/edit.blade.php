...
@section('title', 'Ürün SSS Güncelleme')
<?php 
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Ürün SSS Güncelleme</h3></div>
              <div class="col-sm-6">
        ...
        <div class="app-content">
                ...
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <form action="{{ route('admin.product.faq.store', $id, $faqId) }}" method="POST" enctype="multipart/form-data">
                            @csrf
