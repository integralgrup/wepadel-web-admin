...
@section('title', 'Ürün Özellik(Feature) Ekleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Ürün Özellik(Feature) Ekleme</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Ürün Özellik(Feature) Yönetimi</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body grids-4">
                                        ...
                                        <div class="mb-3">
                                            <label for="left_{{ $language->lang_code }}" class="form-label">Sol ({{ strtoupper($language->lang_code) }})</label>
                                            <input type="text" class="form-control" id="left_{{ $language->lang_code }}" name="left_{{ $language->lang_code }}" {{ $required }}>
                                        </div>

                                        <div class="mb-3">
                                            <label for="top_{{ $language->lang_code }}" class="form-label">Üst ({{ strtoupper($language->lang_code) }})</label>
