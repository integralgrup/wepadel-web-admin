...
@section('title', 'Ürün Tipi Listesi')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Ürün Tipi Listesi</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">{{$product->title}} - Ürün Tipi Listesi</h5>
                            <a href="{{ route('admin.product.type.create', $product->id) }}" class="btn btn-primary">
                            ...
                            <tbody>
                                @foreach($types as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.product.type.edit', [$id, $item->type_id]) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <form action="{{ route('admin.product.type.destroy', [$id, $item->type_id]) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
