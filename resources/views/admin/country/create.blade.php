...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Ülke Ekleme</h3></div>
              <div class="col-sm-6">
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="code_{{ $language->lang_code }}" name="code_{{ $language->lang_code }}" {{ $required }}>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="continent_id_{{ $language->lang_code }}" name="continent_id_{{ $language->lang_code }}" {{ $required }}>
                                                ...
                                                @foreach($continents as $continent)
                                                    <option value="{{ $continent->continent_id }}">{{ $continent->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <!-- left --> 
