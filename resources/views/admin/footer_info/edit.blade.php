                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="address_{{ $language->lang_code }}" name="address_{{ $language->lang_code }}" required value="{{ $footerInfo->where('lang', $language->lang_code)->first()->address ?? '' }}">
                                        </div>
                                        <!-- title_1 -->
                                        <div class="mb-3">
                                            <label for="phone_{{ $language->lang_code }}" class="form-label">Telefon ({{ $language->lang_code }})</label>
                                            <input type="text" class="form-control" id="phone_{{ $language->lang_code }}" name="phone_{{ $language->lang_code }}" required value="{{ $footerInfo->where('lang', $language->lang_code)->first()->phone ?? '' }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="email_{{ $language->lang_code }}" class="form-label">E-posta ({{ $language->lang_code }})</label>
                                            <input type="text" class="form-control" id="email_{{ $language->lang_code }}" name="email_{{ $language->lang_code }}" required value="{{ $footerInfo->where('lang', $language->lang_code)->first()->email ?? '' }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="map_url_{{ $language->lang_code }}" class="form-label">Harita URL ({{ $language->lang_code }})</label>
                                            <input type="text" class="form-control" id="map_url_{{ $language->lang_code }}" name="map_url_{{ $language->lang_code }}" required value="{{ $footerInfo->where('lang', $language->lang_code)->first()->map_url ?? '' }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="facebook_url_{{ $language->lang_code }}" class="form-label">Facebook URL ({{ $language->lang_code }})</label>
                                            <input type="text" class="form-control" id="facebook_url_{{ $language->lang_code }}" name="facebook_url_{{ $language->lang_code }}" required value="{{ $footerInfo->where('lang', $language->lang_code)->first()->facebook_url ?? '' }}">
                                        </div>
                                        
                                        <!-- youtube_url -->
                                        <div class="mb-3">
                                            <label for="youtube_url_{{ $language->lang_code }}" class="form-label">YouTube URL ({{ $language->lang_code }})</label>
                                            <input type="text" class="form-control" id="youtube_url_{{ $language->lang_code }}" name="youtube_url_{{ $language->lang_code }}" value="{{ $footerInfo->where('lang', $language->lang_code)->first()->youtube_url ?? '' }}">
                                        </div>
                                        <!-- linkedin_url -->
                                        <div class="mb-3">
                                            <label for="linkedin_url_{{ $language->lang_code }}" class="form-label">LinkedIn URL ({{ $language->lang_code }})</label>
                                            <input type="text" class="form-control" id="linkedin_url_{{ $language->lang_code }}" name="linkedin_url_{{ $language->lang_code }}" value="{{ $footerInfo->where('lang', $language->lang_code)->first()->linkedin_url ?? '' }}">
                                        </div>
                                        <!-- x_url -->
                                        <div class="mb-3">
                                            <label for="x_url_{{ $language->lang_code }}" class="form-label">X URL ({{ $language->lang_code }})</label>
                                            <input type="text" class="form-control" id="x_url_{{ $language->lang_code }}" name="x_url_{{ $language->lang_code }}" value="{{ $footerInfo->where('lang', $language->lang_code)->first()->x_url ?? '' }}">
                                        </div>
                                        <!-- instagram_url -->
                                        <div class="mb-3">
                                            <label for="instagram_url_{{ $language->lang_code }}" class="form-label">Instagram URL ({{ $language->lang_code }})</label>
                                            <input type="text" class="form-control" id="instagram_url_{{ $language->lang_code }}" name="instagram_url_{{ $language->lang_code }}" value="{{ $footerInfo->where('lang', $language->lang_code)->first()->instagram_url ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                            @endforeach
