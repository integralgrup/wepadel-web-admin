...
@section('title', 'Seo Ayarları Listesi')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Seo Ayarları Listesi</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Seo Ayarları Listesi</h5>
                            ...
                            <tbody class="connectedSortable">
                                @foreach($seo_settings as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.seo.edit', $item->seo_id) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <form action="{{ route('admin.seo.destroy', $item->seo_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
