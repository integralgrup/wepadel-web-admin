        ...
        <div class="wrapper max-w-[1440px] mx-auto w-full px-[30px] flex items-start justify-between gap-[180px] 2xl:gap-[90px] xl:gap-[60px] md:gap-[45px] xs:gap-[30px] md:flex-col">
            <div class="brand-wrapper max-w-[350px] md:max-w-[480px] sm:max-w-full md:w-full sm:mx-auto lg:max-w-[300px] w-full shrink-0 mt-[25px] xs:mt-0">
                ...
                <div class="list grid gap-[40px]">
                    ...
                    <a href="mailto:<?php echo $footer_info ? $footer_info->email : ''; ?>" class="item group/item w-fit text-black flex items-center gap-[10px] hover:text-[#C7234B]">
                    ...
                    <a target="_blank" href="<?php echo $footer_info ? $footer_info->map_url : ''; ?>" class="item group/item w-fit text-black flex gap-[10px] hover:text-[#C7234B]">
                ...
                <div class="social mt-[45px] xs:mt-[30px]">
                    ...
                    <div class="list flex items-center gap-[30px] justify-self-center">
                        ...
                        <a target="_blank" href="<?php echo $footer_info ? $footer_info->linkedin_url : ''; ?>" class="block group relative before:absolute before:left-[50%] before:top-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:w-[40px] before:h-[40px] before:rounded-full before:bg-[#0055A3] before:scale-75 before:opacity-0 before:duration-350 hover:before:scale-100 hover:before:opacity-100">
                        ...
                        <a target="_blank" href="<?php echo $footer_info ? $footer_info->x_url : ''; ?>" class="block group relative before:absolute before:left-[50%] before:top-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:w-[40px] before:h-[40px] before:rounded-full before:bg-[#0055A3] before:scale-75 before:opacity-0 before:duration-350 hover:before:scale-100 hover:before:opacity-100">
                        ...
                        <a target="_blank" href="<?php echo $footer_info ? $footer_info->instagram_url : ''; ?>" class="block group relative before:absolute before:left-[50%] before:top-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:w-[40px] before:h-[40px] before:rounded-full before:bg-[#0055A3] before:scale-75 before:opacity-0 before:duration-350 hover:before:scale-100 hover:before:opacity-100">
                            <div class="icon instagram relative z-2 block leading-none duration-350 text-[#C7234B] group-hover:text-[#C7234B] group-hover:scale-110">
                                <svg width="22" height="18" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="1" y="1" width="48" height="48" rx="12" stroke="#c7234b" stroke-width="2"/>
                                <circle cx="25" cy="25" r="11" stroke="#c7234b" stroke-width="2"/>
                                <circle cx="38.5" cy="11.5" r="2.5" fill="#c7234b"/>
                                </svg>
                            </div>
                        </a>
                    </div>
